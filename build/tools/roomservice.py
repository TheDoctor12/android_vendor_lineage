...
custom_default_revision =  "lineage-22.1"
custom_dependencies = "lineage.dependencies"
org_manifest = "TheDoctor12"  # leave empty if org is provided in manifest
org_display = "Lineage OS Mod"  # needed for displaying
...
def main():
    ...
    for repository in repositories:
        ...
        adding = [{'repository': "TheDoctor12/" + repo_name, 'target_path': repo_path}]
